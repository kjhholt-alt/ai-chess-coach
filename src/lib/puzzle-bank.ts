...
// Hand-curated puzzles. The full PUZZLE_BANK appends Lichess-sourced
// puzzles to this list (see below).
const CURATED_PUZZLES: PuzzleData[] = [
...
// Lichess-sourced puzzles (CC0). Generated by
// scripts/fetch_lichess_puzzles.py — validated FEN + UCI legal-in-sequence.
// Hand-curated bank fills the beginner end; Lichess fills the medium-to-expert
// range (1000-2600 ratings, themes including decoy/deflection/mateIn3 that the
// curated bank was thin on).
// eslint-disable-next-line import/no-relative-packages
import { LICHESS_PUZZLES } from "./puzzle-bank-lichess";

export const PUZZLE_BANK: PuzzleData[] = [...CURATED_PUZZLES, ...LICHESS_PUZZLES];
